...
| [TP-Link HS110 & KP115](https://amzn.to/3ws5kVG) WiFi Smart Plug with energy monitoring| Component: [switch.tplink](https://home-assistant.io/components/switch.tplink/) <br>WiFi controlled plugin adapter with Energy monitoring. Enabling actions/automation to be triggered based on power usage. |
| [Tapo P110](https://amzn.to/4bHEPf3) WiFi Smart Plug with energy monitoring| Component: [HACS Custom Component](https://github.com/petretiandrea/home-assistant-tapo-p100)<br>WiFi controlled plugin adapter with Energy monitoring. Enabling actions/automation to be triggered based on power usage. Tapo is a new range of products from TP-Link. |
